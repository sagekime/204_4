...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Ramsey\textquotesingle{}s Rule: discount rate}
\NormalTok{r }\OtherTok{\textless{}{-}}\NormalTok{ .}\DecValTok{001} \SpecialCharTok{+} \DecValTok{2}\SpecialCharTok{*}\NormalTok{.}\DecValTok{01}

\CommentTok{\#SCC at discount rate of .021 (Ramsey\textquotesingle{}s Rule)}
\FunctionTok{PV\_calc}\NormalTok{(warming}\SpecialCharTok{$}\NormalTok{damages\_ton, .}\DecValTok{021}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#Calculate PV using \textasciitilde{}for loop\textasciitilde{}}
\NormalTok{PV\_calc }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(values, discount\_rate) \{}
\NormalTok{  sum }\OtherTok{\textless{}{-}} \DecValTok{0}\NormalTok{;}
\NormalTok{  r }\OtherTok{\textless{}{-}}\NormalTok{ discount\_rate}
  \ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(values))) \{}
\NormalTok{    current }\OtherTok{\textless{}{-}}\NormalTok{ values[i]}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{+}\NormalTok{ r)}\SpecialCharTok{\^{}}\NormalTok{i}
\NormalTok{    sum }\OtherTok{\textless{}{-}}\NormalTok{ sum }\SpecialCharTok{+}\NormalTok{ current}
\NormalTok{  \}}
  \FunctionTok{return}\NormalTok{(sum)}
\NormalTok{\}}

\CommentTok{\#Create new variable for 1.5x baseline in policy A}
\NormalTok{warming}\SpecialCharTok{$}\NormalTok{baseline150 }\OtherTok{\textless{}{-}}\NormalTok{ warming}\SpecialCharTok{$}\NormalTok{warming\_baseline}\SpecialCharTok{*}\FloatTok{1.5}

\CommentTok{\#Create new variable for damages under 1.5 baseline outcome}
\NormalTok{warming}\SpecialCharTok{$}\NormalTok{damages\_baseline150 }\OtherTok{\textless{}{-}} \FunctionTok{damages\_model}\NormalTok{(warming}\SpecialCharTok{$}\NormalTok{baseline150)}

\CommentTok{\#Calculate PV of each outcome in policy A}
\NormalTok{A\_baseline }\OtherTok{\textless{}{-}} \FunctionTok{PV\_calc}\NormalTok{(warming}\SpecialCharTok{$}\NormalTok{damages\_baseline, }\FloatTok{0.02}\NormalTok{)}
\NormalTok{A\_baseline150 }\OtherTok{\textless{}{-}} \FunctionTok{PV\_calc}\NormalTok{(warming}\SpecialCharTok{$}\NormalTok{damages\_baseline150, }\FloatTok{0.02}\NormalTok{)}

\NormalTok{expected\_value }\OtherTok{\textless{}{-}}\NormalTok{ .}\DecValTok{5}\SpecialCharTok{*}\NormalTok{A\_baseline }\SpecialCharTok{+}\NormalTok{ .}\DecValTok{5}\SpecialCharTok{*}\NormalTok{A\_baseline150}
...
\NormalTok{warming }\OtherTok{\textless{}{-}}\NormalTok{ warming }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{warming\_baseline\_2050 =} 
           \FunctionTok{case\_when}\NormalTok{(year }\SpecialCharTok{\textgreater{}} \DecValTok{2050} \SpecialCharTok{\textasciitilde{}} \FloatTok{1.29}\NormalTok{,}
                     \ConstantTok{TRUE} \SpecialCharTok{\textasciitilde{}}\NormalTok{ warming\_baseline}
\NormalTok{          ))}

\CommentTok{\#Create new variable for damages under 2050 baseline outcome}
\NormalTok{warming}\SpecialCharTok{$}\NormalTok{damages\_baseline2050 }\OtherTok{\textless{}{-}} \FunctionTok{damages\_model}\NormalTok{(warming}\SpecialCharTok{$}\NormalTok{warming\_baseline\_2050)}

\CommentTok{\#Calculate PV of policy B}
\NormalTok{B\_baseline }\OtherTok{\textless{}{-}} \FunctionTok{PV\_calc}\NormalTok{(warming}\SpecialCharTok{$}\NormalTok{damages\_baseline2050, }\FloatTok{0.02}\NormalTok{) }\CommentTok{\#PV is expected value bc only one option}
\NormalTok{B\_baseline}
\end{Highlighting}
\end{Shaded}
