...
Suppose undertaking Policy A costs zero and undertaking Policy B costs X. How large could X be for it to still make economic sense to pursue Policy B instead of Policy A? Qualitatively, how would your answer change if society were risk averse?
...
Craig's best guess, but let's please discuss this more:
If society were risk averse, X would have to be less than the max because the expected utility of Policy A would be less than the utility of Policy B. 